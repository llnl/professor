...
#flux: -t 12h
#flux: -q pbatch
#flux: --output=point_diffusion_voxel.out
#flux: --error=point_diffusion_voxel.err
...
# Launch one training rank per GPU. Gradient accumulation gives an effective
# per-rank batch of BATCH_SIZE * BATCH_MULTIPLIER.
